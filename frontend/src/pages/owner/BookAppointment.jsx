...
export default function BookAppointment({ me }) {
    ...
    // Arama Formu State'leri (opsiyonel: start/end default bugünden)
    ...
    const handleSearch = async (e) => {
        ...
        // ✅ Tarih validasyonu (backend'e gitmeden)
        const start = searchForm.startDate;
        const end = searchForm.endDate;

        if (!start) {
            setMsg({ type: "error", text: "Lütfen başlangıç tarihi seçin." });
            return;
        }

        if (start < todayStr) {
            setMsg({ type: "error", text: "Başlangıç tarihi bugünden önce olamaz." });
            return;
        }
        ...
        try {
            ...
            if (sortedData.length === 0) {
                setMsg({
                    type: "info",
                    text: "Aranan kriterlere uygun boş randevu bulunamadı.",
                });
            }
        } catch (err) {
            ...
            <form onSubmit={handleSearch} style={searchBarGrid}>
                <div style={inputGroup}>
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            setSearchForm({ ...searchForm, petId: e.target.value })
                        }
                    >
                ...
                <div style={inputGroup}>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setSearchForm({ ...searchForm, district: e.target.value })
                        }
                    />
                </div>
                ...
                <div style={inputGroup}>
                    ...
                    <input
                        type="date"
                        required
                        min={todayStr} // ✅ bugünden önce seçilemez
                        style={inputStyle}
                        ...
                        onChange={(e) => {
                            ...
                            setSearchForm((prev) => ({
                                ...prev,
                                startDate: nextStart,
                                // ✅ start ileri alındıysa end geride kalmasın
                                endDate:
                ...
                <div style={inputGroup}>
                    ...
                    <input
                        type="date"
                        required
                        min={searchForm.startDate || todayStr} // ✅ end, start'tan önce olamaz
                        style={inputStyle}
                        value={searchForm.endDate}
                        onChange={(e) =>
                            setSearchForm((prev) => ({ ...prev, endDate: e.target.value }))
                        }
                    />
                </div>
            ...
            <div style={slotGridStyle}>
              ...
              <span style={{ fontWeight: "800", color: "#0284c7" }}>
                ...
                {slot.time.substring(0, 5)}
                        ...
                        <div style={{ fontSize: "13px", color: "#64748b", margin: "4px 0" }}>
                            {slot.clinicName}
                        </div>
